...
export default function AuthSplitLayout({ children }: AuthSplitLayoutProps) {
  ...
  const highlights = [
    {
      icon: BookOpen,
      label: tk('authSplit.highlightBank'),
    },
    {
      icon: Target,
      label: tk('authSplit.highlightTests'),
    },
    {
      icon: Trophy,
      label: tk('authSplit.highlightProgress'),
    },
  ];
