...
router.get('/quizzes/random-preview-access', authRequired, quizController.getRandomQuizPreviewAccess);
router.post('/quizzes/random-preview', authRequired, quizController.getRandomQuizPreview);
router.get('/quizzes/:id', authRequired, quizController.getQuizDetail);
